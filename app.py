...
@app.route("/four_fingers")
def four_finger():
    return render_template('four_fingers.html')
...
def test_four_finger_model():
    ...
    plot_srcs = ['../static/four_fingers/index.png', '../static/four_fingers/middle.png',
                 '../static/four_fingers/ring.png',
                 '../static/four_fingers/pinky.png']
    errors = ['Index error: ' + str(errors[0]), 'Middle error: ' + str(errors[1]), 'Ring error: ' + str(errors[2]),
              'Pinky error: ' + str(errors[3])]

    return render_template('four_fingers.html', error_index=errors[0], error_middle=errors[1], error_ring=errors[2],
